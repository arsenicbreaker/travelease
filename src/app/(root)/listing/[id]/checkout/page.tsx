        ...
        <div className="w-full max-w-[460px] pt-[50px]">
          <div>
            ...
            <div className="rounded-[30px] mt-2.5 p-[30px] bg-white border border-border shadow-indicator space-y-5">
              ...
              <div className="space-y-5">
                <CardBooking title="Total days" value="5 days" />
                <CardBooking title="Sub total" value="Rp2.500.000" />
                <CardBooking title="Tax (15%)" value="Rp250.000" />
                <CardBooking title="Insurance" value="Rp100.000" />
                <CardBooking title="Grand total price" value="Rp2.850.000" />
              </div>
            </div>
          </div>
          ...
          <div className="mt-[30px]">
            ...
            <div className="rounded-[30px] mt-2.5 p-[30px] bg-white border border-border shadow-indicator space-y-5">
              ...
              <CardBooking title="Bank Name" value="TravelEase Fi" />
              <CardBooking title="Account Holder" value="PT TravelEase Indonesia" />
              <CardBooking title="Number" value="15021998" />
